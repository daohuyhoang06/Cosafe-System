document.addEventListener("DOMContentLoaded", function () {
  ...
  let suggestionsBox = document.getElementById(
  ...
  input.addEventListener("input", function () {
    ...
    debounceTimeout = setTimeout(() => {
      fetch("http://127.0.0.1:8000/api/products/autocomplete", {
        method: "POST",
        ...
        .then((data) => {
          ...
          if (!data.products || data.products.length === 0) {
            suggestionsBox.innerHTML =
              '<div class="no-suggestion">No suggestions found.</div>';
            suggestionsBox.style.display = "block";
            return;
          }
          suggestionsBox.innerHTML = data.products
            ...
            <div class="suggestion-item" tabindex="0">
              <img src="${
                product.link_image || "assets/images/product-placeholder.jpg"
              }" class="suggestion-img" alt="">
        ...
        .catch(() => {
          positionSuggestionBox();
          suggestionsBox.innerHTML =
            '<div class="no-suggestion">Error loading suggestions.</div>';
          suggestionsBox.style.display = "block";
        });
    }, 250);
  });
